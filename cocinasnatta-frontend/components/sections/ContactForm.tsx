    ...
    <section className="relative min-h-screen w-full flex items-center justify-center pt-32 pb-20 px-4 bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="relative z-20 w-full max-w-6xl flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        <div className="lg:w-1/2 w-full">
          <div className="bg-white/5 backdrop-blur-2xl p-8 md:p-12 rounded-[2.5rem] border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.5)]">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-white text-black font-bold uppercase tracking-[0.2em] py-5 rounded-xl hover:bg-zinc-200 transition-all duration-500 flex items-center justify-center gap-3 group"
              >
                Enviar Solicitud
